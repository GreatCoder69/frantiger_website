...
import "./Food.css";
import Fimg from "../../../Assets/images/Listings/food.png";
...
import { FoodcardData } from "../Food/FoodcardData";
...
const Food = () => {
  ...
  const toggleShare = (index) => {
    const content = FoodcardData[index];
    if (content) {
      setShareContent({
        title: content.title,
  ...
  const cardChunks = chunkArray(FoodcardData, 3); // Split cardsData into chunks of 3
  ...
  return (
    <div className="FoodMain">
      ...
      <div className="FoodTitle">
        <h1 className="FTitleinner">
          <span style={{ color: "#e78c1c", padding: "0px", fontSize: "75px" }}>
            Food
          </span>{" "}
          <div className="dropdown">
            <span
              className="dropbtn"
              style={{ color: "#f1f1f1", fontSize: "75px" }}
            >
              Listings
            </span>
