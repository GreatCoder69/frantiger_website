...
import Limg from "../../../Assets/images/Listings/logistics.png";
import Card from "react-bootstrap/Card";
import cimage from "../../../Assets/otherImage/firefox-cycles-franchise-_8.jpg";

import { LogisticscardData } from "../Logistics/LogisticscardData";
...
const Logistics = () => {
  ...
  const toggleShare = (index) => {
    const content = LogisticscardData[index];
    if (content) {
      setShareContent({
        title: content.title,
  ...
  const cardChunks = chunkArray(LogisticscardData, 3); // Split cardsData into chunks of 3

  return (
    <div>
      <div className="LogisticsMain">
        {/* Navbar */}
        <div className="Limg">
          <img src={Limg} alt="image" />
        </div>
      </div>

      <div className="LTitle">
        <h1 className="LTitleinner">
          <span style={{ color: "#e78c1c" }}>Logistics </span>
        ...
        <div className="boxx">
          ...
          <div class="checkbox-container">
            ...
            <label style={{ paddingLeft: "1.8rem" }} for="checkbox6">
