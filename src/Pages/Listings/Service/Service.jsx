...
import ssimg from "../../../Assets/images/Listings/services.png";
import Card from "react-bootstrap/Card";
import "./Service.css";
import { useNavigate } from "react-router-dom";

import { ServicecardData } from "../Service/ServicecardData";
...
const Service = () => {
  ...
  const handleCloseModal = () => {
    ...
    const toggleShare = (index) => {
      const content = ServicecardData[index];
      if (content) {
        setShareContent({
          title: content.title,
  ...
  const cardChunks = chunkArray(ServicecardData, 3); // Split cardsData into chunks of 3
    ...
    <div>
      <div className="CMain">
        ...
        <div className="serviceimg">
          <img src={ssimg} alt="image" />
        </div>
      </div>

      <div className="ssTitle">
        <h1 className="ssTitleinner">
          <span style={{ color: "#e78c1c" }}>Services </span>
