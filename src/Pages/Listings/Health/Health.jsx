...
import "./Health.css";
import himg from "../../../Assets/images/Listings/health.png";
import Card from "react-bootstrap/Card";
import cimage from "../../../Assets/otherImage/firefox-cycles-franchise-_8.jpg";
import { useNavigate } from "react-router-dom";
import { HealthcardData } from "../Health/HealthcardData";
...
const Health = () => {
  ...
  const toggleShare = (index) => {
    const content = HealthcardData[index];
    if (content) {
      setShareContent({
        title: content.title,
  ...
  const cardChunks = chunkArray(HealthcardData, 3); // Split cardsData into chunks of 3
  ...
  return (
    <div className="HealthMain">
      ...
      <div className="HTitle">
        <h1 className="HTitleinner">
          <span style={{ color: "#e78c1c" }}>Health</span>{" "}
